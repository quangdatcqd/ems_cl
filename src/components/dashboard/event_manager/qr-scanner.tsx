...
function QRScanner({ eventData, handleCloseDlg }: EventCreateFormProps) { 
    ...
    const handleCheckin = async (result: any, error: any) => {
        ...
        eventParticipantService.checkinByTicketCode(eventData._id, result).then((res: any) => {
    ...
    return (<>
        ...
        <DialogContent sx={{ paddingBottom: 0 }}>
            ...
            <p className="text-xl uppercase text-[orange] text-center w-[100%] mb-3 ">{eventData?.name}</p>
            {
